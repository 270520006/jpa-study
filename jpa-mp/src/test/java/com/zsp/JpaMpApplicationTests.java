...
//        2.设置数据源 就是数据库配置
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/jpa_mp?serverTimezone=Asia/Shanghai");
...
//        4.策略：映射对应的表
        ...
        strategy.setInclude("person"); //要映射的表名，要弄几个表出来，上面这是四个
